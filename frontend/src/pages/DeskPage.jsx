...
const files = [
  ...
  },
  {
    ...
    benefit:
      "African violets thrive in low to moderate light, making them ideal for offices, even under fluorescent lamps, but avoid direct sunlight.",
  },
  {
    id: 4,
    type: "image",
    ...
    name: "Rex Begonia",
    benefit: "Rex Begonias are vibrant, decorative indoor plants known for their colorful, patterned leaves, low maintenance, and ability to brighten up indoor spaces.",
  },
  {
    id: 5,
    type: "image",
    ...
    name: "English Ivay",
    benefit:
      "English ivy thrives in medium to bright indirect light, can be shaped on trellises, adds decorative greenery, and tolerates indoor office conditions, though it's toxic to people and pets.",
  },
  {
    id: 6,
    type: "image",
    ...
    name: "Philodendron",
    benefit: "Philodendrons are easy-to-care-for indoor plants that thrive in low to medium light, improve air quality, and add lush, decorative foliage to any space.",
  },
  {
    id: 7,
    type: "image",
  ...
  },
  {
    ...
    name: "Tillandsia",
    benefit: "Tillandsia (air plants) are low-maintenance, don’t require soil, improve indoor air quality, and add a unique, decorative touch to any space.",
  },
  {
    id: 9,
    type: "image",
    ...
    name: "Wood Sorrel",
    benefit:
      "Wood sorrel (Oxalis spp.) is a small, low-maintenance plant that adds attractive foliage and delicate flowers to indoor spaces, improves air quality, and can be used ornamentally for a refreshing, natural aesthetic.",
  },
  {
    id: 10,
    type: "image",
